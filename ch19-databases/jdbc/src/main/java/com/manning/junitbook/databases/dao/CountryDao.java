...
import com.manning.junitbook.databases.ConnectionManager;
...
public class CountryDao {
    ...
    public List<Country> getCountryList() {
        ...
        try {
            ...
            while (resultSet.next()){
                countryList.add(
                        new Country(resultSet.getString(2), resultSet.getString(3))
                );
            }
            statement.close();
    ...
    public List<Country> getCountryListStartWith(String name) {
        ...
        try {
            statement = connection.prepareStatement(GET_COUNTRIES_BY_NAME_SQL);
